    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-white p-0 opacity-50 hover:opacity-100 border-gray-300 hover:bg-gray-50"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-gray-100 text-gray-700"
        ),
        ...
        day_range_middle:
          "aria-selected:bg-blue-50 aria-selected:text-gray-700",
